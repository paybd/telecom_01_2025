...
export default function ByMobile() {
  const router = useRouter();

const [wallet_no, setwallet_no] = useState('')


const getBkashWallet = async()=>{
  let { data, error } = await supabase
  .from('paymentAccounts')
  .select("*")

  // Filters
  .eq('wallet_type', 'bkash')
...
<Text style={[styles.label, { fontSize: 22, marginVertical: 10 }]}>
          ১। নিচের বিকাশ নাম্বার এ টাকা পাঠান
        </Text>
          ...
          <View style={styles.paymentStyle}>
            ...
            >
              ...
              <Text style={styles.paymentText}>বিকাশ পার্সোনাল</Text>
            </View>
